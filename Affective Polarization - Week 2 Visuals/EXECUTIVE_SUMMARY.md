# Affective Polarization Analysis: Executive Summary
**UNC Charlotte Student Survey - Fall 2025**  
*Analysis Date: February 05, 2026*  
*Sample Size: N = 779 (Republicans: 130, Democrats: 437, Independents: 84)*
...
- **Democrats**: M = 2.89, SD = 0.78
- **Republicans**: M = 2.32, SD = 0.62
- **Difference**: t(562) = -7.78, p < .001, Cohen's d = 0.82
...
- **Democrats**: M = 2.67, SD = 0.84 (lower = more supportive of freedom)
- **Republicans**: M = 3.27, SD = 0.88
- **Difference**: t(542) = 6.93, p < .001, Cohen's d = 0.69
...
|-------|------|----|----|
| **Democrats** | 3.37 | 1.02 | Moderate connection |
| **Republicans** | 2.96 | 1.08 | Moderate connection |

- **Statistical Test**: t = -3.95, p = 0.0001, d = 0.39
...
| Party | Mean | SD | Interpretation |
|-------|------|----|----|
| **Democrats** | 2.96 | 0.97 | Moderate othering |
| **Republicans** | 2.56 | 0.93 | Moderate othering |

- **Statistical Test**: t = -4.12, p = 0.0000, d = 0.42
...
| Party | Mean | SD | Interpretation |
|-------|------|----|----|
| **Democrats** | 2.32 | 1.06 | Low-moderate aversion |
| **Republicans** | 1.42 | 0.61 | Very low aversion |

- **Statistical Test**: t = -9.14, p < .001, d = 1.04
...
**Republicans**:
- Correlation: r = 0.172, p = 0.0506 (ns)
- **Finding**: No significant relationship

**Democrats**:
- Correlation: r = -0.035, p = 0.4761 (ns)
- **Finding**: No significant relationship - polarization does not predict free speech attitudes
...
- **Republicans** (Q135, Q136, Q137-reversed): Mean inter-item r = 0.418 ✓
- **Democrats** (Q138, Q139, Q140-reversed): Mean inter-item r = 0.613 ✓
...
2. **Social Distance**: The large effect size for social aversion (d = 1.04) suggests Democrats maintain greater social distance from Republicans, with potential implications for cross-party dialogue and campus climate.
...
- **Response Rate**: Data available for 779 complete responses
